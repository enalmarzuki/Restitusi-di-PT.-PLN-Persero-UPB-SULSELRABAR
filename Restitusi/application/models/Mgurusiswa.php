...
class Mgurusiswa extends CI_Model {
    ...
    public function uploadguruuser(){
        $cek_berita =
            $this->db->select('id')
                ->from('tb_user')
                ->order_by('id','DESC')
    ...
    function deletegurusiswa($nim){
        $this->db->where('nim',$nim);
        $this->db->delete('tb_siswa');
    }

    public function deleteguruuser($nim){
