  ...
  <div role="main">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Silahkan Input Biodata Guru</h2>
          ...
          <form role="form" method="post" action="<?=base_url('index.php/DashadminGuru/uploadGuru')?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10 col-sm-6 col-xs-12">
                <input value="guru" type="text" name="level_user" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-10 col-sm-6 col-xs-12">
              <input type="text" name="nama_guru" required="required" class="form-control col-md-7 col-xs-12">
            </div>
           </div>
           ...
           <br> 
            <div class="form-group">
              <label class="control-label col-md-2 col-sm-3 col-xs-12">No. Handphone<span class="required">*</span></label>
              <div class="col-md-10 col-sm-6 col-xs-12">
           ...
           <br> 
            <div class="form-group">
              <label class="control-label col-md-2 col-sm-3 col-xs-12">Mata Pelajaran<span class="required">*</span></label>
              <div class="col-md-10 col-sm-6 col-xs-12">
              <select name="mata_pelajaran" required="required" class="form-control col-md-7 col-xs-12">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              <a href="<?=base_url('index.php/DashadminGuru');?>"> <button class="btn btn-primary" type="button">Batalkan</button></a>
