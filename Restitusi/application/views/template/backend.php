...
<html lang="en">
  <head>
    ...
    <title>Sistem Informasi Restitusi</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
           <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><!-- <i class=></i> --> <span>Restitusi</span></a>
            </div>
      ...
      <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        <div class="menu_section">
          ...
          <ul class="nav side-menu">
            ...
            <li><a href="<?php echo base_url();?>index.php/DashadminHome/index"><i class="fa fa-home"></i> Home </a>
            <!-- <li><a href="<?php echo base_url();?>index.php/DashadminSiswa/tambahAdminsiswa"><i class="fa fa-users"></i> Tambah User </a> -->

           <!--  <li><a href="<?php echo base_url();?>index.php/Dashuser/index"><i class="fa fa-users"></i> Admin </a> -->

            <li><a href="<?php echo base_url();?>index.php/C_Pegawai/index"><i class="fa fa-users"></i> Pegawai </a>
           <!--  <li><a href="<?php echo base_url();?>index.php/DashadminSiswa/index"><i class="fa fa-users"></i> Add Restitusi </a> -->

            <li><a href="<?php echo base_url();?>index.php/C_Restitusi/index"><i class="fa fa-users"></i> Restitusi </a>
           <!-- <li><a href="<?=base_url('dashuser');?>"><i class="fa fa-users"></i> View </a>  -->
				 </ul>
				</div>
        ...
        <!-- footer content -->
       	<footer>
    			<div class="pull-right">
    				Software as System by <a href="https://www.facebook.com/marzuki.r"> &copy; <span style="color: darkred">Marzuki . R</span></a>
    			</div>
    			<div class="clearfix"></div>
    		</footer>
        <!-- /footer content -->
