...
<html lang="en">
  <head>
    ...
    <title>Rapor Online Siswa</title>
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <!--<img src='".base_url("gambar/".$data->gambar)."' width='100' height='100'>-->
                <!--<?php 
                  $this->db->select('id');  // memilih database berdasarkan id / auto increment di database
                  $this->db->select('gambar'); // memilih kolom pict dari tabel yg ada di database untuk didefinisikan lebih lanjut
                  $query = $this->db->get('tb_foto'); // memanggil database berdasarkan nama table
                  ...
                  ?>
                  <img src="<?php echo base_url('gambar/'.$gambar['gambar']) ?>" class="img-circle profile_img">
                  <?php } ?> -->
      ...
      <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        <div class="menu_section">
          ...
          <ul class="nav side-menu">
            <!--<li><a href="<?=base_url('index.php/raporsiswa');?>"><i class="fa fa-home"></i> Home </a>-->
            <li><a href="<?=base_url('index.php/Dashsiswa');?>"><i class="fa fa-users"></i> Siswa </a>
				 </ul>
				</div>
