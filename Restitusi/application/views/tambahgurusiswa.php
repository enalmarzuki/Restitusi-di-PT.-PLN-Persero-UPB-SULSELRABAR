<!-- page content -->
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Silahkan Input File Restitusi</h2>
          ...
          <form role="form" method="post" action="<?php echo base_url();?>index.php/DashguruSiswa/uploadgurusiswa" enctype="multipart/form-data" class="form-horizontal form-label-left">
