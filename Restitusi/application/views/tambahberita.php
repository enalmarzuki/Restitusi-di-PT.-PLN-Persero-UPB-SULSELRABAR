<!-- page content -->
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <form role="form" method="post" action="<?php echo base_url();?>index.php/DashadminSiswa/uploadBerita" enctype="multipart/form-data" class="form-horizontal form-label-left">
