          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <br/>
                ...
                <form role="form" method="post" action="<?=base_url('index.php/DashguruSiswa/updategurusiswa')?>" enctype="multipart/form-data" class="form-horizontal form-label-left">

                <input value="<?= $berita['nim'];?>" type="hidden" name="nim">
                <input value="<?= $berita['foto_siswa'];?>" type="hidden" name="foto_siswa">

                  <div class="form-group">
                    <label class="control-label col-md-2 col-sm-3 col-xs-12">Nama Siswa <span class="required">*</span>
                    </label>
                    <div class="col-md-10 col-sm-6 col-xs-12">
                      <input type="text" name="nama_siswa" value="<?= $berita['nama_siswa'];?>" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-6 col-xs-12">
                      <input type="text" name="alamat" value="<?= $berita['alamat'];?>" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <a href="<?=base_url('index.php/DashguruSiswa');?>"> <button class="btn btn-primary" type="button">Batalkan</button></a>
